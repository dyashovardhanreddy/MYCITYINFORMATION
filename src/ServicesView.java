...
public class ServicesView extends JFrame {
	...
	private JLabel lbl_select_cityname;
	private JLabel lbl_select_service;
	...
	public ServicesView()
	{
		...
		lbl_select_cityname=new JLabel("Select CityName:");
		lbl_select_service=new JLabel("Serivce Avaliable:");
		...
		panel.add(lbl_select_cityname);
		panel.add(cmbCityname);
		panel.add(btn_view);
		panel.add(lbl_select_service);
		...
		btn_view.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{  
					...
					Statement stmt=con.createStatement();  
					String selectedCity=cmbCityname.getSelectedItem()+"";
					String query="select services from services where cityname='"+selectedCity+"'";
					ResultSet rs=stmt.executeQuery(query);
					servicesList=new ArrayList();
					while(rs.next())  
						servicesList.add(rs.getString(1)+"");
					int count=cmbServices.getItemCount();
