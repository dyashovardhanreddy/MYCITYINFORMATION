...
import javax.swing.*;
public class TouristPlacesInsert extends JFrame {
	...
	public TouristPlacesInsert()
	{
		...
		cmbrating=new JComboBox<String>(ratings);
		...
		this.setTitle("TouristPlaces : Insert");
		...
		btninsert.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
					...
					{
						JOptionPane.showMessageDialog(null, "Give Landmark");
					}
					else if(txtplacename.getText().compareTo("")==0)
					{
						JOptionPane.showMessageDialog(null, "Give Place Name");
					}
					else if(cmbrating.getSelectedIndex()==0)
					{
						JOptionPane.showMessageDialog(null, "Select Rating");
					}
					else
					{
						try
						{
							...
							Connection con=DriverManager.getConnection( "jdbc:oracle:thin:@localhost:1521:xe","yasho","password");  
					  
							Statement stmt=con.createStatement();  
					   
							int x=stmt.executeUpdate("insert into tourist_places values('"+txtplacename.getText()+"','"+txtlandmark.getText()+"','"+cmbrating.getSelectedItem()+"')");  
