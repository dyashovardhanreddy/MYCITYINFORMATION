...
import java.awt.*;
public class MetroStationsDelete extends JFrame{
	...
	public MetroStationsDelete()
	{
		...
		this.setTitle("Metro Sation: Delete");
		...
		btndelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try{  
					...
					int rows=stmt.executeUpdate("delete  from metrostations where station_name='"+cmbmetrostations.getSelectedItem()+"'");  
