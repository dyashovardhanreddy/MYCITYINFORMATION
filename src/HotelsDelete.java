...
import javax.swing.*;
public class HotelsDelete extends JFrame{
	...
	public HotelsDelete()
	{
		...
		cmbhotels=new JComboBox(hotelList.toArray());
		...
		btndelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try{  
					...
					int rows=stmt.executeUpdate("delete from hotels where hotel_name='"+cmbhotels.getSelectedItem()+"'");
					System.out.println("yes");
					txtmessage.setText("Deleted "+rows+" rows");
					con.commit();
					hotelList=new ArrayList();
					ResultSet rs=stmt.executeQuery("select hotel_name from hotels");  
					while(rs.next())  
					...
					{
						cmbhotels.addItem(hotelList.get(i)+"");
					}
