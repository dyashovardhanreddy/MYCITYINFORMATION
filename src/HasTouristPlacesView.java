...
import javax.swing.*;
public class HasTouristPlacesView extends JFrame{
	...
	public HasTouristPlacesView()
	{
		...
		lblselectplacename=new JLabel("Placename Avaliable:");
		...
		this.setTitle("Has Tourist Places : View");
		...
		cmbplacename.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try{  
					...
					if(cmbplacename.getSelectedIndex()==0)
					{
