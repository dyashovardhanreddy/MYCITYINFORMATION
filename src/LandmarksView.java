...
import javax.swing.*;
public class LandmarksView extends JFrame{
		...
		btnupdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try{  
					...
					int x=stmt.executeUpdate("update landmarks set cityname='"+txtCitynameUpdate.getText()+"',landmark='"+txtLandmarkUpdate.getText()+"' where cityname='"+cmbcityname.getSelectedItem()+"' and landmark='"+cmblandmark.getSelectedItem()+"'");  
					con.commit();
					txtmessage.setText("Updated "+x+" row");
