...
import javax.swing.*;
public class HasHotelsView extends JFrame{
	...
	public HasHotelsView()
	{
		...
		lblselectcityname=new JLabel("City:");
		lblselecthotel=new JLabel("Hotels:");
		txtcityname=new JTextField(20);
		txthotelname=new JTextField(20);
		...
		cmbhotel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				txthotelname.setText(cmbhotel.getSelectedItem()+"");
			}
		});
