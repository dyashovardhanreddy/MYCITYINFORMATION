...
import javax.swing.*;
public class HasMetroStationView extends JFrame{
	...
	public HasMetroStationView()
	{
		...
		lblselectmetrostation=new JLabel("MetroStations:");
		...
		this.setTitle("Has MetroStation : View");
